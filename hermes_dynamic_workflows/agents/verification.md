...
- "I don't have a browser" -- did you actually check for browser automation tools? If present, use them. If a browser tool fails, troubleshoot (server running? selector right?). The fallback exists so you don't invent your own "can't do this" story.
